# 🗄 SPK CLAUDE.md アーカイブ（2026 上半期・2026-04〜05 詳細ログ）

> 本体 `~/spk-task/CLAUDE.md` から容量対策（2026-07-21）で退避した過去の修正履歴・インシデント詳細。
> 削除ではなく分離。恒久ルールは本体06〜07月項＋グローバルCLAUDE.mdに反映済み。
> 再発調査時はここをgrepする。

---

# === Block A: 2026-05月 + 2026-04-30 修正履歴 ===
...
# === Block B: 2026-04月 修正履歴 + じゃらん事前決済PJ + 旧インシデント履歴 ===
