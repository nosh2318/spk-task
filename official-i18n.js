...
(function(){
  ...
  var FLOW={
   ...
   en:{fl_change:'Change search',resv_jp:'Reservation',
    ...
    chosen_head:'🚙 Selected car',confirm_head:'📋 Confirm your booking',pay_head:'💳 Payment',pay_desc:'Pay by card in advance (Square) or at the store.<br>Tap “Confirm booking” to finalize; a confirmation email will be sent.',terms_head:'📄 Rental Agreement',terms_read:'Please read the Rental Agreement before booking (scroll below to review).',terms_agree:'I agree to the Rental Agreement (required to confirm your booking)',terms_view:'📄 Open full text in a new tab',terms_need:'You must agree to the Rental Agreement.',done_head:'Your booking is complete',
   ...
   zh:{fl_change:'變更條件',resv_jp:'預約',
    ...
    chosen_head:'🚙 已選車輛',confirm_head:'📋 確認預約內容',pay_head:'💳 付款',pay_desc:'可預先刷卡（Square）或到店付款。<br>按「確定預約」即完成預約，並寄送確認信。',terms_head:'📄 租車約款',terms_read:'預約前請務必閱讀租車約款（可向下捲動確認）。',terms_agree:'我同意租車約款（未同意將無法確定預約）',terms_view:'📄 於新分頁開啟全文',terms_need:'需要同意租車約款。',done_head:'預約完成',
   ...
   ko:{fl_change:'조건 변경',resv_jp:'예약',
    ...
    chosen_head:'🚙 선택한 차량',confirm_head:'📋 예약 내용 확인',pay_head:'💳 결제',pay_desc:'사전 카드 결제(Square) 또는 매장 결제가 가능합니다.<br>「예약 확정」을 누르면 예약이 확정되고 확인 메일이 발송됩니다.',terms_head:'📄 대여 약관',terms_read:'예약 전에 대여 약관을 반드시 읽어 주세요(아래로 스크롤하여 확인).',terms_agree:'대여 약관에 동의합니다(동의하지 않으면 예약을 확정할 수 없습니다)',terms_view:'📄 새 탭에서 전문 열기',terms_need:'대여 약관 동의가 필요합니다.',done_head:'예약이 완료되었습니다',
