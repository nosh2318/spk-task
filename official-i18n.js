...
(function(){
  ...
  var FLOW={
   ja:{fl_change:'条件を変更',resv_jp:'ご予約',
    ...
    chosen_head:'🚙 選択中の車両',confirm_head:'📋 ご予約内容の確認',pay_head:'💳 お支払い',pay_desc:'事前カード決済（Square）または店頭でのお支払いに対応しています。<br>「予約を確定する」を押すと予約が確定し、確認メールをお送りします。',done_head:'ご予約が完了しました',
    cta_back:'← 戻る',cta_total:'合計（1日あたり）',cta_options:'オプション・補償へ →',cta_customer:'お客様情報へ →',cta_confirm:'入力内容を確認する →',cta_done:'予約を確定する',
   ...
   en:{fl_change:'Change search',resv_jp:'Reservation',
    ...
    chosen_head:'🚙 Selected car',confirm_head:'📋 Confirm your booking',pay_head:'💳 Payment',pay_desc:'Pay by card in advance (Square) or at the store.<br>Tap “Confirm booking” to finalize; a confirmation email will be sent.',done_head:'Your booking is complete',
    cta_back:'← Back',cta_total:'Total (per day)',cta_options:'To options & coverage →',cta_customer:'To your info →',cta_confirm:'Review details →',cta_done:'Confirm booking',
   ...
   zh:{fl_change:'變更條件',resv_jp:'預約',
    ...
    chosen_head:'🚙 已選車輛',confirm_head:'📋 確認預約內容',pay_head:'💳 付款',pay_desc:'可預先刷卡（Square）或到店付款。<br>按「確定預約」即完成預約，並寄送確認信。',done_head:'預約完成',
    cta_back:'← 返回',cta_total:'合計（每日）',cta_options:'前往加購・保障 →',cta_customer:'前往顧客資料 →',cta_confirm:'確認輸入內容 →',cta_done:'確定預約',
    ...
    air_go_place:'接送（去程）地點',air_ret_place:'接送（回程）地點',air_selectable:'（可選）',air_sel:'請選擇',air_time_go:'預約時間',air_time_ret:'還車時間',air_flight:'抵達航班編號（選填）',ph_flight:'例）NH1234',air_hint:'提供免費接送（那覇機場／赤嶺站）。請分別選擇去程・回程地點。時間依前一頁的取還時間（變更請按「變更」）。',store_l:'到店門市',store_hint:'於門市交還車。到店時間依日期時間。聯絡方式請於顧客資料填寫。',
   ...
   ko:{fl_change:'조건 변경',resv_jp:'예약',
    ...
    chosen_head:'🚙 선택한 차량',confirm_head:'📋 예약 내용 확인',pay_head:'💳 결제',pay_desc:'사전 카드 결제(Square) 또는 매장 결제가 가능합니다.<br>「예약 확정」을 누르면 예약이 확정되고 확인 메일이 발송됩니다.',done_head:'예약이 완료되었습니다',
    cta_back:'← 뒤로',cta_total:'합계(1일당)',cta_options:'옵션·보장으로 →',cta_customer:'고객 정보로 →',cta_confirm:'입력 내용 확인 →',cta_done:'예약 확정',
  ...
  // ===== 確認明細 / 受取詳細 / 札幌デリバリー地図 =====
  var FLOW2={
   ja:{cf_store:'店舗',cf_recvm:'受取方法',cf_use:'ご利用',cf_booker:'ご予約者',cf_none:'なし',cf_days_unit:'日間',cf_x:'×',
   ...
   en:{cf_store:'Store',cf_recvm:'Pickup method',cf_use:'Duration',cf_booker:'Booker',cf_none:'None',cf_days_unit:'day(s)',cf_x:'×',
   ...
   zh:{cf_store:'門市',cf_recvm:'取車方式',cf_use:'租用',cf_booker:'預約人',cf_none:'無',cf_days_unit:'日',cf_x:'×',
   ...
   ko:{cf_store:'매장',cf_recvm:'수령 방법',cf_use:'이용',cf_booker:'예약자',cf_none:'없음',cf_days_unit:'일간',cf_x:'×',
