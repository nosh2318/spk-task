...
(function(){
  ...
  var FLOW={
   ...
   zh:{fl_change:'變更條件',resv_jp:'預約',
    ...
    air_go_place:'接送（去程）地點',air_ret_place:'接送（回程）地點',air_selectable:'（可選）',air_sel:'請選擇',air_time_go:'預約時間',air_time_ret:'還車時間',air_flight:'抵達航班編號（選填）',ph_flight:'例）NH1234',air_hint:'提供免費接送（那覇機場／赤嶺站）。請分別選擇去程・回程地點。時間依前一頁的取還時間（變更請按「變更」）。',store_l:'到店門市',store_hint:'於門市交還車。到店時間依日期時間。聯絡方式請於顧客資料填寫。',store_p2:'🅿️ HANDYMAN 那覇機場店（第2停車場）',store_addr:'〒901-0223 沖縄県豊見城市翁長854-1',store_map:'🗺 在地圖上查看',
