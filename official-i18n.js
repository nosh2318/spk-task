...
(function(){
  ...
  var FLOW={
   ja:{fl_change:'条件を変更',resv_jp:'ご予約',
    ...
    chosen_head:'🚙 選択中の車両',confirm_head:'📋 ご予約内容の確認',pay_head:'💳 お支払い',pay_desc:'事前カード決済（Square）または店頭でのお支払いに対応しています。<br>「予約を確定する」を押すと予約が確定し、確認メールをお送りします。',pay_desc2:'お支払い方法をお選びください。「予約を確定する」を押すと予約が確定し、確認メールをお送りします。',pay_card:'💳 事前カード決済（Square）',pay_card_d:'ご予約確定後、決済リンク（Square）をメールでお送りします。',pay_store:'🏬 店頭でお支払い',pay_store_d:'当日の受け渡し時に店頭でお支払いいただけます。',pay_desc3:'クレジットカードでのお支払いです。「予約を確定する」を押すと、ご予約とお支払いが確定します。',pc_accept:'ご利用可能：',pc_num:'カード番号',pc_exp:'有効期限（MM/YY）',pc_cvc:'セキュリティコード',pc_name:'カード名義（ローマ字）',pc_name_ph:'TARO YAMADA',pc_secure:'🔒 カード情報はSSLで暗号化して安全に送信されます。当サイトにカード番号は保存されません。',pc_err_num:'カード番号が正しくありません。',pc_err_exp:'有効期限が正しくありません。',pc_err_cvc:'セキュリティコードが正しくありません。',pc_err_name:'カード名義をご入力ください。',terms_head:'📄 貸渡約款',terms_read:'ご予約前に貸渡約款を必ずお読みください（下記をスクロールしてご確認いただけます）。',terms_agree:'貸渡約款に同意します（同意しないとご予約を確定できません）',terms_view:'📄 別タブで全文を開く',terms_need:'貸渡約款へのご同意が必要です。',done_head:'ご予約が完了しました',
