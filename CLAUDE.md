...
- **状態**：2026-07-21 **本稼働ON**（`spk_line_config.license_auto_enabled=true`）。pg_cron `license-reminder-spk`(jobid38・`0 1 * * *`=10:00JST・active)が起動。#handyman_development に「札幌のみ」報告＋「那覇も同仕様希望か」確認を投稿済(ts 1784591017)。**那覇展開は返答待ち**。
